import { boolean, index, jsonb, pgTable, text, timestamp, uuid, unique, decimal, pgEnum } from 'drizzle-orm/pg-core'
...
export const pantryItems = pgTable(
  ...
  (table) => [
    ...
    index('idx_pantry_items_user_ingredient').on(table.userId, table.ingredientId),
  ],
)
