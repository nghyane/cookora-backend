...
export const vietnameseRecipeSearchSchema = z.object({
  ...
  // Sorting
  sortBy: z.enum(['created_at', 'updated_at', 'cooking_time', 'title'] as const).default('created_at'),
...
// Export types
export type VietnameseIngredientBase = z.infer<typeof vietnameseIngredientBaseSchema>
...
export type VietnameseRecipeSearch = z.infer<typeof vietnameseRecipeSearchSchema>
